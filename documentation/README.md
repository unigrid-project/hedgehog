...
| [Grid sporks](sporks.md) | The signed parameter records: type hierarchy, what bytes are signed, which keys are trusted and how a second one co-signs, persistence, mutation, propagation and the wire encoding | Changing network parameters, signing or the spork database |
