...
public class P2PServer extends AbstractServer {
    ...
    public void configure(NetOptions netOptions) {
        this.netOptions = netOptions;
    }

    public void start(NetOptions netOptions) throws CertificateException, InterruptedException {
        this.netOptions = netOptions;
        ...
        System.out.println("P2PServer started on " + netOptions.getHost() + ":" + netOptions.getPort());
    }
