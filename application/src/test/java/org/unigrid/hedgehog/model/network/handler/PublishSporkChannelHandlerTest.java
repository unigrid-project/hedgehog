...
public class PublishSporkChannelHandlerTest extends BaseHandlerTest<PublishSpork, PublishSporkChannelHandler> {
    ...
    public Arbitrary<GridSpork> provideGridSpork(
            ...
            @ForAll @Size(value = 60) byte[] signature,
            @ForAll Instant time,
    ...
    public void shoulBeAbleToPublishSpork(
        ...
        for (TestServer server : servers) {
            ...
            // Använder direkt konstruktor istället för builder()
            final PublishSpork publishSpork = new PublishSpork(gridSpork);
