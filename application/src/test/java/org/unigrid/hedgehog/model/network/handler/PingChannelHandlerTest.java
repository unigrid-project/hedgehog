...
import java.util.concurrent.atomic.AtomicInteger; // Tillagd för timeout
...
public class PingChannelHandlerTest extends BaseHandlerTest<Ping, PingChannelHandler> {
    ...
    public void shoulBeAbleToPingNetwork(@ForAll("provideTestServers") List<TestServer> servers,
        ...
        for (TestServer server : servers) {
            ...
            // Tillagd timeout på 10 sekunder
            await().atMost(10, TimeUnit.SECONDS).untilAtomic(invocations, is(expectedInvocations));
