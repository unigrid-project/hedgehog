...
@Command(name = "gridspork-log")
public class GridSporkLog extends RestClientCommand {
	public GridSporkLog() {
		super(HttpMethod.GET, "/gridspork/log", Optional.of(() -> "No sporks to show a signature log for"));
	}
