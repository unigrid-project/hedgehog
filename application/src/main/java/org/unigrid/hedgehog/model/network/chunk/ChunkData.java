 ...
 */
    ...
    /**
     * Gemensamt gränssnitt för alla ChunkData.
     */
    @JsonTypeInfo(use = JsonTypeInfo.Id.DEDUCTION)
    @JsonSubTypes({
            @JsonSubTypes.Type(MintStorage.SporkData.class),
            @JsonSubTypes.Type(MintSupply.SporkData.class),
            @JsonSubTypes.Type(VestingStorage.SporkData.class)
    })
